...
class Config:
    ...
    if not db_url:
        ...
        try:
            ...
            print("\n[Warning] Connection to Render PostgreSQL timed out (local network/firewall blocking port 5432).")
            print("[Warning] Falling back to local SQLite database so the app can start.")
