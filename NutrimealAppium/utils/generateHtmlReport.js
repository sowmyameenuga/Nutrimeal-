...
function generateHtmlReport(stats, results, outDir) {
...
<head>
    ...
    <title>Mega Android E2E Execution Report</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>Mega Android E2E Execution Report</h1>
            <p>1,111 Tests Suite - Nutritional App Mobile Appium</p>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>${r.title}</td>
                    <td><span class="badge ${r.passed ? 'passed' : 'failed'}">${r.passed ? 'PASSED' : 'FAILED'}</span></td>
                    <td>${r.duration}</td>
                </tr>
                `).join('')}
            </tbody>
